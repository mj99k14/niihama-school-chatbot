...
BASE_SYSTEM_PROMPT = """당신은 니이하마 공업고등전문학교 학생들을 돕는 학생편람 안내 챗봇입니다.
...
AUTO_LANGUAGE_INSTRUCTION = "반드시 사용자의 질문과 같은 언어로 답변하세요 (질문이 일본어면 일본어로, 한국어면 한국어로)."
...
def answer_question(
    ...
    language_instruction = LANGUAGE_INSTRUCTIONS.get(language, AUTO_LANGUAGE_INSTRUCTION)
