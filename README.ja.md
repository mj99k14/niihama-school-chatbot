...
<img src="docs/qr-code.png" alt="チャットボット QR コード" width="160" />
...
質問入力から回答表示までのリクエストフロー(根拠資料を先に表示した後、Claude の応答をトークン単位でストリーミング):

![RAG チャットボット シーケンス図](docs/rag-sequence-diagram.png)
